    ...
    CredentialsProvider({
      ...
      async authorize(credentials) {
        try {
          ...
          console.error("[auth/authorize] before prisma user.findUnique");
          const user = await prisma.user.findUnique({
            where: { email: credentials.email },
            include: { company: true },
          });
          console.error("[auth/authorize] after prisma user.findUnique");
          ...
          console.error("[auth/authorize] before prisma manager.findUnique");
          ...
          console.error("[auth/authorize] after prisma manager.findUnique");
