...
coaching_focus — «План действий на следующую неделю»:
  ...
  ЗАПРЕЩЕНО: одинаковые формулировки типа «разобрать 2-3 звонка на встрече 1:1 и
  зафиксировать скрипт». Каждый из 5 пунктов — уникальное конкретное действие.
  Примеры правильных формулировок:
    - «Провести прослушку звонков Марины за неделю — отметить 3 момента где не назвала УТП»
    - «На ближайшем 1:1 показать пример успешного pitch конкурентного отличия из лучшего звонка»
    - «Поставить Марине задачу: в следующих 5 звонках предложить допуслугу хотя бы один раз»
  Никаких внутренних технических терминов в тексте (company_profile, skill_breakdown,
  risk_id и подобных). Писать как живой коуч, не как система.
